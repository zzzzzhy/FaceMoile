...
JNIEXPORT jboolean
JNICALL
Java_www_zzzzzhy_org_facemoile_RetinaFace_faceDetectionModelInit(JNIEnv *env, jobject instance,
...
JNIEXPORT jboolean
JNICALL
Java_www_zzzzzhy_org_facemoile_RetinaFace_setThreadsNumber(JNIEnv *env, jobject instance,
                                                     jint threadsNumber) {
    if (!detection_sdk_init_ok) {
...
JNIEXPORT jintArray
JNICALL
Java_www_zzzzzhy_org_facemoile_RetinaFace_faceDetect(JNIEnv *env, jobject instance, jbyteArray imageDate_,
